        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gaps-12 ">
          ...
          <div>
            ...
            <h1
              data-aos="fade-down"
              data-aos-delay="100"
              className="text-2xl md:text-3xl lg:text-4xl my-5 text-gray-300 font-semibold"
            >
            ...
            <h1
              data-aos="fade-down"
              data-aos-delay="100"
              className="text-bg text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold md:leading-[3rem] lg:leading-[3.5rem] xl:leading-[4rem] text-primary"
            >
              {BaseInfo.position}
            </h1>
            {/* Description */}
            <p
              data-aos="fade-up"
              data-aos-delay="200"
              className="mt-6 text-sm md:text-base text-primary text-opacity-60"
            >
          ...
          <div
            data-aos="zoom-in"
            data-aos-delay="400"
            className="m-auto p-auto w-[18.75rem] h-[18.75rem] md:w-[400px] md:h-[380px] md:flex lg:block rounded-[3rem] border-[3.5px] border-green-950 overflow-hidden"
          >
            <Image
